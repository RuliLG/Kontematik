...
(0,tippy_js__WEBPACK_IMPORTED_MODULE_3__.delegate)('.tooltip-parent', {
  target: '[data-tooltip]',
...
window.addEventListener('load', function () {
  var apiKeyMeta = document.querySelector('meta[name="api_token"]');

  if (apiKeyMeta) {
    setTimeout(function () {
      if (!window.kontematikExtension) {
        var isChromeBased = !!window.chrome;
        var $alert = document.querySelector('#kontematik-extension-alert');
...
if (apiKeyMeta) {
  window.axios.defaults.headers.common['Authorization'] = 'Bearer ' + apiKeyMeta.getAttribute('content');
}
/**
