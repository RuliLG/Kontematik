    ...
    <div class="py-6 px-4 sm:p-6 lg:pb-8">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Fill your profile for a more customized experience.
            </p>
        </div>
    ...
    <div class="pt-6 divide-y divide-gray-200">
        <div class="px-4 sm:px-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    You get to decide what we can do.
                </p>
            </div>
                ...
                <li class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                        <p class="text-sm font-medium text-gray-900" id="privacy-option-1-label">
                            Notify me about new tools
                        </p>
                        <p class="text-sm text-gray-500" id="privacy-option-1-description">
                            We will send you an email when we release new tools. You can unsubscribe at any time.
                        </p>
                    </div>
                ...
                <li class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                        ...
                        <p class="text-sm text-gray-500" id="privacy-option-2-description">
                            We have more products on our roadmap you may be interested in.
                        </p>
                    </div>
        ...
        <div class="p-4 sm:p-6">
            <div class="rounded-lg border border-red-600 p-4 sm:p-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Changes here will not be reversible. Be careful!
                    </p>
                </div>
                <ul class="mt-2 divide-y divide-gray-200">
                    <li class="py-4 flex items-center justify-between">
                        <div class="flex flex-col">
                            ...
                            <p class="text-sm text-gray-500" id="privacy-option-1-description">
                                We will delete your account within all your data.
                            </p>
                        </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex-1">
                                ...
                                <span class="block mt-1 text-sm text-gray-600">Type <strong><em>{{ $deletionKey }}</em></strong> to confirm</span>
                            </div>
